...
export const VillaData: Villa[] = [
  ...
  },
  {
    ...
    gallery: [
    { url: '/assets/images/villa/arjuna/cover.webp', alt: 'Minimalist bedroom with low platform bed, white linens, single artwork, and sliding doors to zen garden' },
    { url: '/assets/images/villa/arjuna/bed.webp', alt: 'Meditation room with tatami mats, cushions, incense altar, and natural light from skylight' },
    { url: '/assets/images/villa/arjuna/outside.webp', alt: 'Zen garden with raked gravel patterns, stone lanterns, bamboo fence, and koi pond' },
    { url: '/assets/images/villa/arjuna/interior.webp', alt: 'Open living space with minimal furniture, natural materials, and seamless indoor-outdoor flow' },
    { url: '/assets/images/villa/arjuna/bath.webp', alt: 'Reflection pool with stepping stones, surrounded by bamboo and tropical plants' },
    { url: '/assets/images/villa/arjuna/plang.webp', alt: 'Tea ceremony room with low table, floor cushions, and traditional Japanese aesthetic' }],
